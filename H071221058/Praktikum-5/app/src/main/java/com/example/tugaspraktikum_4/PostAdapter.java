...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        ...
        // Mengecek tipe data dari imagePost
        if (user.getImagePost() instanceof Integer) {
            // Jika integer, maka setImageResource menggunakan integer
            holder.post.setImageResource((Integer) user.getImagePost());
        } else {
        ...
        // Memberi onClickListener pada username untuk membuka profil
        ...
        // Memberi onClickListener pada ikon hapus untuk menghapus postingan
    ...
    // ViewHolder untuk tampilan item post
